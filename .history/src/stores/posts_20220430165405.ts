...
export const usePostsStore = defineStore('postsModule', {
  ...
  getters: {
    ...
    dialogAccountAdd: (state) => state._dialogAccountAdd,
  ...
  actions: {
    ...
    restoreCurrent() {
      this._posts[this.postCurIndex] = { ...this.postCurrent, trash: false };
    },
    trash(post: Post) {
    ...
    setDialogAccountAdd(value: boolean) {
      this._dialogAccountAdd = value;
    },
  },
});
