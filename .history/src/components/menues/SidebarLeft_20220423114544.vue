<template>
  <q-list class="sidebar-left" dark>
    <!-- <q-item
      clickable
      v-ripple
      class="sidebar-header column q-py-xl"
    >
      <q-item-section
        avatar
        class="q-mb-md"
    ...
    <q-item>
      <q-item-section class="q-py-sm">
        <q-item-label class="text-h6">Note App</q-item-label>
      </q-item-section>
    </q-item>
...
import { iSidebarMenuItem } from 'components/models';

export default defineComponent({
  name: 'SidebarLeft',
  props: {
    routes: {
      type: Array as PropType<Array<Array<iSidebarMenuItem>>>,
      required: true,
    },
  },
});
