...
import AddLoginForm from 'components/partials/forms/AddLoginForm.vue';
import AddNoteForm from 'components/partials/forms/AddNoteForm.vue';
import AddCardForm from 'components/partials/forms/AddCardForm.vue';
