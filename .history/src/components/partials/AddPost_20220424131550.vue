...
import AddLoginForm from 'src/components/forms/AddLoginForm.vue';
import AddNoteForm from 'src/components/forms/AddNoteForm.vue';
import AddCardForm from 'src/components/forms/AddCardForm.vue';
